...
const LaunchSuccess = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-black'>
      ...
      <div className='pt-18'>
        <div className="w-full min-h-screen bg-[url('https://res.cloudinary.com/dc7bb6868/image/upload/v1772797323/Gemini_Generated_Image_efw7ybefw7ybefw7_1_fr4nfs.png')] bg-cover bg-center px-4 sm:px-8 lg:px-0 md:bg-[url('./assets/LaunchSuccessbg.png')]">
